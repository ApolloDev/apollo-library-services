 ...
 */
public class GetApprovedRevisionOfLibraryItemMethod extends BaseLibraryServiceAccessorMethod {

	public GetApprovedRevisionOfLibraryItemMethod(String username, String password, SerializationFormat serializationFormat) throws UnsupportedSerializationFormatException {
	...
	public String getLibraryItemReleaseVersion(int urn) {
		...
		Object result;
		try {
			result = impl.getApprovedRevisionOfLibraryItem(urn, authentication);
